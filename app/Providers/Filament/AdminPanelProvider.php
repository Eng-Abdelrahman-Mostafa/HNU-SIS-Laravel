...
use App\Filament\Widgets\EnrollmentsLast14DaysChart;
use App\Filament\Widgets\QuickActions;
use App\Filament\Widgets\RegistrationWindowInfo;
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->widgets([
                ...
                RegistrationWindowInfo::class,
                EnrollmentsLast14DaysChart::class,
            ])
            ->plugins([
